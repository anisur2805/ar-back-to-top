...
function arbtt_display() {
	...
	// Border Radius
	// add_settings_field('arbtt_bdr', '<label for="arbtt_bdr">'.__('Button Border' , 'arbtt' ).'</label>', 'arbtt_bdr_cb', 'arbtt', 'arbtt_ssection_id');
	...
	// Fade In
	add_settings_field('arbtt_fadein', '<label for="arbtt_fadein">'.__('Font Icon' , 'arbtt' ).'</label>', 'arbtt_fadein_cb', 'arbtt', 'arbtt_ssection_id');
...
function arbtt_bdr_cb(){ ?>
	<!-- <input type="number" name="arbtt_bdr" class="aras" id="arbtt_bdr" class="arbtt_bdr" placeholder="2" value="<?php //echo get_option('arbtt_bdr') ?>"/><span class="description"><?php// echo __('Pixels', 'arbtt'); ?></span> -->
<?php }
function arbtt_bdrd_cb(){ ?>
	<input type="number" name="arbtt_bdrd" class="aras" id="arbtt_bdrd" class="arbtt_bdrd" placeholder="1" value="<?php echo get_option('arbtt_bdrd') ?>"/><span class="description"><?php echo __('Pixels', 'arbtt'); ?></span>
<?php }
...
function arbtt_btnapr_cb(){ ?>
	<input type="text" name="arbtt_btnapr" class="aras arbtt_btnapr" id="arbtt_btnapr" placeholder="100" value="<?php echo get_option('arbtt_btnapr');?>"/><span class="description"><?php echo __('Pixels', 'arbtt') ?></span>
<?php }
$arbtt_btndm = get_option('arbtt_btndm');
function arbtt_btndm_cb(){
	global $arbtt_btndm;?>
	<input type="text" name="arbtt_btndm[w]" class="aras arbtt_btndm ardm" id="arbtt_btndm" placeholder="60" value="<?php echo $arbtt_btndm['w'];?>"/> X <input type="text" name="arbtt_btndm[h]" class="aras arbtt_btndm ardm" id="arbtt_btndm" placeholder="60" value="<?php echo $arbtt_btndm['h'];?>"/><span class="description"><?php echo __('Width & Height (Pixels)', 'arbtt') ?></span>
<?php }
function arbtt_btnoc_cb(){?>
	<input type="text" min="0.0" max="1.0" name="arbtt_btnoc" class="aras arbtt_btnoc" id="arbtt_btnoc" placeholder="0.6" value="<?php echo get_option('arbtt_btnoc');?>"/><span class="description"><?php echo __('Min 0.0 - Max 1.0', 'arbtt') ?></span>
<?php }
...
function arbtt_fadein_cb(){?>
	<input type="text" name="arbtt_fadein" class="aras arbtt_fadein" id="arbtt_fadein" placeholder="800" value="<?php echo get_option('arbtt_fadein');?>"/><span class="description"><?php echo __('Mili-second', 'arbtt') ?></span>
<?php }
