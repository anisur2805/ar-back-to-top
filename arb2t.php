...
<!-- <input type="number" name="arbtt_bdr" class="aras" id="arbtt_bdr" class="arbtt_bdr" placeholder="2" value="<?php //echo get_option('arbtt_bdr') ?>"/><span class="description"><?php// echo __('Widthout Pixels', 'arbtt'); ?></span> -->
<?php }
...
<!-- <input type="text" name="arbtt_bdclr" class="arcs arbtt_bdclr" id="arbtt_bdclr" placeholder="#000" value="<?php echo get_option('arbtt_bdclr'); ?>"/><span class="description">Widthout Pixels</span> -->
<?php }
...
function arbtt_enqueue($hook) {
	...
	wp_enqueue_script('arbtt_minucolor_js', plugins_url('assets/js/jquery.minicolors.min.js', __FILE__ ), true);
