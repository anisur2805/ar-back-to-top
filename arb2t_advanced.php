...
function arbtt_btnapr_cb(){ ?>
	...
	<span class="description"><?php echo __('Widthout Pixels', 'arbtt') ?></span>
<?php }
$arbtt_btndm = get_option('arbtt_btndm["w"]');
...
function arbtt_fz_cb(){ 
	echo '
	<input type="text" name="arbtt_fz" class="aras arbtt_fz" id="arbtt_fz" placeholder="24px" value="'.get_option('arbtt_fz').'"/>
	<span class="description">'.__('Widthout Pixels', 'arbtt').'</span>
	';
}
...
<?php
$arbtt_bgc = (get_option('arbtt_bgc')) ?: '#000';
